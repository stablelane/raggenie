...
class CosmosMongoDB(BaseVectorDB):
    ...
    def connect(self):
        try:
            ...
            logger.info(f"Connected to Cosmos MongoDB Vector Database")
    ...
    def _create_index(self, collection, index_name):
        index = list(collection.index_information())
                ...
                "indexes": [
                    {
                        ...
                        "cosmosSearchOptions": {
                            "kind":       "vector-ivf",
                            "numLists":   1,      # tune for your data size
